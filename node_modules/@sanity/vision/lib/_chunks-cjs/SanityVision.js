...
function PerspectivePopover() {
  const [open, setOpen] = react.useState(!1), buttonRef = react.useRef(null), popoverRef = react.useRef(null), handleClick = react.useCallback(() => setOpen((o) => !o), []), { t } = sanity.useTranslation(index.visionLocaleNamespace);
...
function VisionContainer(props) {
  ...
  if (!loadedDatasets)
    return /* @__PURE__ */ jsxRuntime.jsx(ui.Flex, { align: "center", height: "fill", justify: "center", children: /* @__PURE__ */ jsxRuntime.jsx(DelayedSpinner, {}) });
