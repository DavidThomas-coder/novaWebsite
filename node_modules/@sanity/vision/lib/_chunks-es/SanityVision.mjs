...
import { Spinner, rem, useTheme, Box, useClickOutsideEvent, Popover, Stack, Inline, Text, Badge, Card, Button, Code, Tooltip, Flex, Label, Grid, Select, TextInput, Hotkeys, useToast, Container, Heading } from "@sanity/ui";
import { useState, useEffect, useMemo, useCallback, useRef, PureComponent, createRef, Component } from "react";
...
function PerspectivePopover() {
  const [open, setOpen] = useState(!1), buttonRef = useRef(null), popoverRef = useRef(null), handleClick = useCallback(() => setOpen((o) => !o), []), { t } = useTranslation(visionLocaleNamespace);
...
function VisionContainer(props) {
  ...
  if (!loadedDatasets)
    return /* @__PURE__ */ jsx(Flex, { align: "center", height: "fill", justify: "center", children: /* @__PURE__ */ jsx(DelayedSpinner, {}) });
