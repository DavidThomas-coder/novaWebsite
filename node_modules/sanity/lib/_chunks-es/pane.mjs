...
const DISABLED_REASON_KEY$2 = {
  ...
  return useMemo(() => !published || liveEdit ? null : !isPermissionsLoading && !(permissions != null && permissions.granted) ? {
    tone: "critical",
    icon: ResetIcon,
    disabled: !0,
...
const PublishAction = (props) => {
  ...
  return useMemo(() => {
    ...
    const disabled = !!(publishScheduled || (_a2 = editState == null ? void 0 : editState.transactionSyncLock) != null && _a2.enabled || publishState === "publishing" || publishState === "published" || hasValidationErrors || publish.disabled);
    return {
    ...
    currentUser,
    (_a = editState == null ? void 0 : editState.transactionSyncLock) == null ? void 0 : _a.enabled,
    handle,
    hasValidationErrors,
    isPermissionsLoading,
    liveEdit,
...
const DISABLED_REASON_KEY = {
  ...
  return useMemo(() => liveEdit ? null : !isPermissionsLoading && !(permissions != null && permissions.granted) ? {
    tone: "critical",
    icon: UnpublishIcon,
    label: "Unpublish",
