...
function useIntentLink(options) {
  const { intent, onClick: onClickProp, params, replace, target, searchParams } = options, { resolveIntentLink } = useRouter(), href = React.useMemo(
...
const IntentLink = React.forwardRef(function(props, ref) {
  const { intent, params, target, searchParams, ...restProps } = props, { onClick, href } = useIntentLink({
    intent,
    params,
    target,
...
function RouterProvider(props) {
  const { onNavigate, router: routerProp, state } = props, resolveIntentLink = React.useCallback(
    (intentName, parameters, _searchParams) => {
